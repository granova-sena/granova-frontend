  ...
  return (
    <div className="min-h-screen bg-[#0a1a0a] text-white">
      ...
      <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-50">
        <button className="flex items-center gap-2 bg-[#1D9E75] text-white px-3 sm:px-4 py-2.5 sm:py-3 rounded-full shadow-lg hover:bg-[#0F6E56] transition-all duration-300 hover:scale-105">
          <span className="text-base sm:text-lg">☕</span>
          <span className="text-xs sm:text-sm font-medium">¿Necesitas ayuda?</span>
        </button>
      </div>
